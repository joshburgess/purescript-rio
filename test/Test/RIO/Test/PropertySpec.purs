module Test.RIO.Test.PropertySpec (spec) where
...
import RIO.Test.Property (defaultSampleCount, forAllRIO, forAllRION, generateSamples)
...
spec :: Spec Unit
spec = describe "RIO.Test.Property" do
