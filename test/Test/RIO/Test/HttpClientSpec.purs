module Test.RIO.Test.HttpClientSpec (spec) where
...
import RIO.HttpClient (HttpError(..), Method(..), RequestBody(..), Request, Response)
import RIO.HttpClient (mockHttpClient) as HC
import RIO.Test.HttpClient (newRecordingHttpClient)
...
spec :: Spec Unit
spec = describe "RIO.Test.HttpClient" do
