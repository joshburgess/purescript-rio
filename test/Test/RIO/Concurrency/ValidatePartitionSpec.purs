module Test.RIO.Concurrency.ValidatePartitionSpec (spec) where
...
import RIO.Concurrency (partitionPar, validatePar)

spec :: Spec Unit
spec = describe "RIO.Concurrency (validatePar / partitionPar)" do
