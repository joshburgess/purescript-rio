module Test.RIO.Concurrency.ZipWithParSpec (spec) where
...
import RIO.Core (RIO, fail, runRIO, runRIO', zipPar, zipWithPar)

spec :: Spec Unit
spec = describe "RIO.Concurrency.zipWithPar" do
