-- | Contract tests for `RIO.WebSocket`. The `RIO.Test.WebSocket`
-- | recording helper has its own spec (`Test.RIO.Test.WebSocketSpec`)
...
-- | constructor.
module Test.RIO.WebSocketSpec (spec) where
...
import RIO.WebSocket (Message(..), mockWebSocket)

spec :: Spec Unit
spec = describe "RIO.WebSocket" do
