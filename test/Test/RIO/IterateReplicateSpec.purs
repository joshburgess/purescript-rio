module Test.RIO.IterateReplicateSpec (spec) where
...
import RIO.Core (RIO, fail, iterate, replicateM, replicateM_, runRIO, runRIO')

spec :: Spec Unit
spec = describe "RIO.Core (replicateM / replicateM_ / iterate)" do
