module Test.RIO.MetricSpec (spec) where
...
import RIO.Metric.Gauge as Gauge
import RIO.Metric.Histogram as Histogram
import RIO.Metric.Summary as Summary

spec :: Spec Unit
spec = describe "RIO.Metric (first-class instruments)" do
