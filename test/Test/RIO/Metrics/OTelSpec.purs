module Test.RIO.Metrics.OTelSpec (spec) where
...
import RIO.Metrics.OTel (ExportConfig)
import RIO.Metrics.OTel as OTel
...
spec :: Spec Unit
spec = describe "RIO.Metrics.OTel (OTLP/JSON exporter)" do
