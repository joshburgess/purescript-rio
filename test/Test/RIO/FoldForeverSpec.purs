module Test.RIO.FoldForeverSpec (spec) where
...
import RIO.Concurrency (forever)
import RIO.Error (foldRIO)

spec :: Spec Unit
spec = describe "RIO.Error.foldRIO / RIO.Concurrency.forever" do
