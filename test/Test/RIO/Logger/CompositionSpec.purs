module Test.RIO.Logger.CompositionSpec (spec) where
...
import RIO.Logger (LogLevel(..), combineLoggers, filterLevel, formatJsonLine)
import RIO.Test.Logger (newRecordingLogger)

spec :: Spec Unit
spec = describe "RIO.Logger (composition)" do
