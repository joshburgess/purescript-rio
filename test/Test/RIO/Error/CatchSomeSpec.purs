module Test.RIO.Error.CatchSomeSpec (spec) where
...
import RIO.Error (catchSome, orElseFail, orElseSucceed)
...
spec :: Spec Unit
spec = describe "RIO.Error (catchSome / orElseSucceed / orElseFail)" do
