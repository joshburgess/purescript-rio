module Test.RIO.Error.RefineSpec (spec) where
...
import RIO.Error (either, refineOrDie, refineOrDieWith) as Error
...
spec :: Spec Unit
spec = describe "RIO.Error (refineOrDie / refineOrDieWith)" do
