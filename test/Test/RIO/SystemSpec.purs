module Test.RIO.SystemSpec (spec) where
...
import RIO.System (System, getArgs, getCwd, lookupEnv)
import RIO.Test.System (newTestSystem)

spec :: Spec Unit
spec = describe "RIO.System + RIO.Test.System" do
