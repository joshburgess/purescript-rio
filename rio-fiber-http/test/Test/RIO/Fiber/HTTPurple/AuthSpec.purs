module Test.RIO.Fiber.HTTPurple.AuthSpec (spec) where
...
import RIO.Fiber.HTTPurple.Auth (bearerAuthConfig, requireAuth)
...
spec :: Spec Unit
spec = describe "RIO.Fiber.HTTPurple.Auth" do
