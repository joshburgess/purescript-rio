-- | Integration tests for `RIO.Fiber.Postgres` against a real Postgres
...
module Test.RIO.Fiber.PostgresSpec (spec) where
...
spec conn = do
  describe "RIO.Fiber.Postgres (integration)" do
