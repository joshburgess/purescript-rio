...
import RIO.Node.HTTP2.Server (toNetServer) as H2Srv
...
roundTrip = do
  certBuf <- FSAff.readFile "rio-node/test/fixtures/http2-localhost-cert.pem"
  keyBuf <- FSAff.readFile "rio-node/test/fixtures/http2-localhost-key.pem"
