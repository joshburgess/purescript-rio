module Test.RIO.Node.ReadLineSpec (spec) where
...
import RIO.Node.EventEmitter as EE
import RIO.Node.ReadLine
  ( closeH
  , lineH
  , output
  , terminal
  ) as Exports
import RIO.Node.ReadLine as RL

runRL :: forall a. RIO () () a -> Aff a
runRL = runRIO'

spec :: Spec Unit
spec = describe "RIO.Node.ReadLine" do
