-- | Integration tests for `RIO.Postgres.Pool` against a real
-- | Postgres instance.
module Test.RIO.Postgres.PoolSpec (spec) where
...
import RIO.Postgres.Pool (PoolStats, poolStats, warmup)
...
spec conn = do
  describe "RIO.Postgres.Pool (integration)" do
