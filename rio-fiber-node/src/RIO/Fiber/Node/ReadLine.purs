...
-- | `RIO.Fiber.Node.EventEmitter`.
module RIO.Fiber.Node.ReadLine
  ( module Exports
  , CursorPos
  , KeySequenceObj
  , blockUntilClosed
...
question txt iface = fromAff (RLAff.question txt iface)
