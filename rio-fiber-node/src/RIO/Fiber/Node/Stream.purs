...
readableToStringUtf8 r = fromAff (NSAff.readableToStringUtf8 r)
...
readableToString
  ...
  -> Encoding
  -> RIO r e String
readableToString r enc = fromAff (NSAff.readableToString r enc)
...
readableToBuffers r = fromAff (NSAff.readableToBuffers r)
...
readSome r = fromAff (NSAff.readSome r)
...
readAll
  :: forall r e w
   . Readable w
  -> RIO r e (Array Buffer)
readAll r = fromAff (NSAff.readAll r)
...
readN
  ...
  -> Int
  -> RIO r e { buffers :: Array Buffer, readagain :: Boolean }
readN r n = fromAff (NSAff.readN r n)
...
writeAll
  ...
  -> Array Buffer
  -> RIO r e Unit
writeAll w bs = fromAff (NSAff.write w bs)
...
endAwait w = fromAff (NSAff.end w)
