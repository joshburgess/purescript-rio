module Test.RIO.Fiber.Node.NetSpec (spec) where
...
import RIO.Fiber.Node.Net (IpFamily(..), isIP, isIPv4, isIPv6) as Net
import RIO.Fiber.Node.Net.Server as Server
import RIO.Fiber.Node.Net.Socket as Socket
import RIO.Fiber.Node.Net.SocketAddress as SA
import RIO.Fiber.Node.Stream as Stream

runN :: forall a. RIO () () a -> Aff a
runN = runAffThrow

spec :: Spec Unit
spec = describe "RIO.Fiber.Node.Net" do
