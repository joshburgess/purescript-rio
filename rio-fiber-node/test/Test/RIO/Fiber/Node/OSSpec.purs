module Test.RIO.Fiber.Node.OSSpec (spec) where
...
runOS p = runAffThrow (provide (fromValue { os: liveOS }) p)

spec :: Spec Unit
spec = describe "RIO.Fiber.Node.OS (live)" do
