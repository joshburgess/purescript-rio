module Test.RIO.Fiber.Node.ChildProcessSpec (spec) where
...
import RIO.Fiber.Node.Buffer as Buf
import RIO.Fiber.Node.ChildProcess
  ( ChildProcess
  , Exit(..)
  , exitH
  ) as Exports
import RIO.Fiber.Node.ChildProcess as CP
...
spec :: Spec Unit
spec = describe "RIO.Fiber.Node.ChildProcess" do
