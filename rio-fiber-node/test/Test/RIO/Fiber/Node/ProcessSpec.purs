module Test.RIO.Fiber.Node.ProcessSpec (spec) where
...
runProc p = runAffThrow (provide (fromValue { process: liveProcess }) p)
...
spec :: Spec Unit
spec = describe "RIO.Fiber.Node.Process (live)" do
