module Test.RIO.Config.FileIntegrationSpec (spec) where
...
import RIO.Config.File (dotenvFileSource, jsonFileSource)
...
spec :: Spec Unit
spec = describe "RIO.Config.File integration" do
