...
-- |   rec <- liftEffect (newRecordingHttpClient
-- |     [ Right { status: 200, statusText: "OK", headers: [], body: "{}" } ])
-- |   _ <- provideAt (Proxy :: Proxy "httpClient") rec.httpClient
-- |          (callUpstream req)
-- |   reqs <- liftEffect rec.snapshot
-- |   Array.length reqs `shouldEqual` 1
-- | ```
module RIO.Fiber.Test.HttpClient
  ( RecordingHttpClient
...
newRecordingHttpClient
  ...
  -> Effect RecordingHttpClient
newRecordingHttpClient script = do
