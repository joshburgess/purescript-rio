...
-- |
-- | Where `RIO.Aff.Metrics.incrementCounter` writes name-keyed
...
-- | reach for `RIO.Aff.Metric.Gauge` instead.
-- |
-- | Intended import:
-- |
-- | ```purescript
-- | import RIO.Aff.Metric.Counter (Counter)
