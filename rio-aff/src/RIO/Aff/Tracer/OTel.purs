...
-- | enters the system, via `RIO.Aff.Tracer.Propagation.newSpanId`).
module RIO.Aff.Tracer.OTel
  ( ExportConfig
  , SpanIdMap
  , exportSpans
  , renderOTLP
...
import RIO.Aff.Tracer (Span, SpanId, SpanStatus(..))
