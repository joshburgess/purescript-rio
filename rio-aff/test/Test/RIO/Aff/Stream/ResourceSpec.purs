module Test.RIO.Aff.Stream.ResourceSpec (spec) where
...
import RIO.Aff.Core (RIO, die, fail, runRIO, runRIO', scoped)
import RIO.Aff.Stream (Stream, flatMap, fromArray, mapM, runCollect, runDrain)
import RIO.Aff.Stream.Resource (bracketStream)

spec :: Spec Unit
spec = do
  describe "RIO.Aff.Stream.Resource" do
