module Test.RIO.Aff.Stream.HaltInterruptSpec (spec) where
...
import RIO.Aff.Deferred (makeDeferred, succeedDeferred, failDeferred)
...
spec :: Spec Unit
spec = describe "RIO.Aff.Stream (haltWhen / interruptWhen)" do
