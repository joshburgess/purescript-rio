module Test.RIO.Aff.RandomSpec (spec) where
...
import RIO.Aff.Random (Random, nextBoolean, nextInt, nextNumber, nextRange)
import RIO.Aff.Test.Random (newTestRandom)

spec :: Spec Unit
spec = do
  describe "RIO.Aff.Random + RIO.Aff.Test.Random" do
