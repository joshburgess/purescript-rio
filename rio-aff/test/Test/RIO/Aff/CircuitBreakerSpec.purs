module Test.RIO.Aff.CircuitBreakerSpec (spec) where
...
import RIO.Aff.Core (RIO, catchAll, fail, provideAll, runRIO)
...
spec :: Spec Unit
spec = describe "RIO.Aff.CircuitBreaker" do
