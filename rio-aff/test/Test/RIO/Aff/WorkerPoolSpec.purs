module Test.RIO.Aff.WorkerPoolSpec (spec) where
...
import RIO.Aff.Deferred (awaitDeferred)
import RIO.Aff.Error (catchAll) as Error
import RIO.Aff.Env (ask) as Env
import RIO.Aff.Resource (Scope, scoped)
import RIO.Aff.WorkerPool as WorkerPool

spec :: Spec Unit
spec = describe "RIO.Aff.WorkerPool" do
