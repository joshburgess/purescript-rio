module Test.RIO.Aff.Tracer.OTelSpec (spec) where
...
import RIO.Aff.Tracer.OTel (ExportConfig)
import RIO.Aff.Tracer.OTel as OTel
...
spec :: Spec Unit
spec = describe "RIO.Aff.Tracer.OTel (OTLP/JSON exporter)" do
