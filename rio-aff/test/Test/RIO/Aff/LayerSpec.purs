module Test.RIO.Aff.LayerSpec (spec) where
...
spec :: Spec Unit
spec = do
  describe "RIO.Aff.Layer (Phase 5.1)" do
  ...
  describe "RIO.Aff.Layer (Phase 5.2)" do
    describe "andThen / (>>>)" do
  ...
  describe "RIO.Aff.Layer (Phase 5.3)" do
  ...
  describe "RIO.Aff.Layer (Phase 5.4)" do
  ...
  describe "RIO.Aff.Layer passthrough" do
