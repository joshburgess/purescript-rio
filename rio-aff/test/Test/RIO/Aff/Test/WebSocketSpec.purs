module Test.RIO.Aff.Test.WebSocketSpec (spec) where
...
import RIO.Aff.WebSocket (Message(..))
import RIO.Aff.Test.WebSocket (newRecordingWebSocket)

spec :: Spec Unit
spec = describe "RIO.Aff.Test.WebSocket" do
