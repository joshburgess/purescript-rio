module Test.RIO.Aff.SqlSpec (spec) where
...
import RIO.Aff.Env (provide)
import RIO.Aff.Sql (Sql, SqlError(..), SqlValue(..), Statement, SqlRow, SqlResult)
...
spec :: Spec Unit
spec = describe "RIO.Aff.Sql (shape-only service)" do
