-- | Smoke test for `RIO.Aff.Console`. These functions are thin
...
-- | design.
module Test.RIO.Aff.ConsoleSpec (spec) where
...
silentTag :: String
silentTag = "[RIO.Aff.ConsoleSpec smoke]"

spec :: Spec Unit
spec = describe "RIO.Aff.Console" do
