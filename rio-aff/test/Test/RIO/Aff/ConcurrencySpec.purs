module Test.RIO.Aff.ConcurrencySpec (spec) where
...
spec :: Spec Unit
spec = do
  describe "RIO.Aff.Concurrency (Phase 6.1)" do
  ...
  describe "RIO.Aff.Concurrency (Phase 6.2)" do
  ...
  describe "RIO.Aff.Concurrency (Phase 6.3)" do
    describe "race" do
  ...
  describe "RIO.Aff.Concurrency extras" do
    describe "parTraverse short-circuit" do
      ...
      it "a defect in one branch propagates via sandbox and interrupts siblings" do
        ...
        -- Aff defects (observable via `RIO.Aff.Error.sandbox`); they
