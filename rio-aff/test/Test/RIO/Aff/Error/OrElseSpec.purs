module Test.RIO.Aff.Error.OrElseSpec (spec) where
...
import RIO.Aff.Error (mapBoth, option, orDie, orElse)

spec :: Spec Unit
spec = describe "RIO.Aff.Error (orElse / option / orDie / mapBoth)" do
