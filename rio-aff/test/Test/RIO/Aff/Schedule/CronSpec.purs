module Test.RIO.Aff.Schedule.CronSpec (spec) where
...
import RIO.Aff.Schedule (Schedule, Step(..), dayOfWeek, hourOfDay, minuteOfHour, step)
import RIO.Aff.Test.Clock (newTestClock)

spec :: Spec Unit
spec = describe "RIO.Aff.Schedule (cron-shaped)" do
