module Test.RIO.Aff.Schedule.ConstructorsSpec (spec) where
...
import RIO.Aff.Schedule (Schedule, Step(..), fromFunction, step, unfold)
...
spec :: Spec Unit
spec = describe "RIO.Aff.Schedule (constructors)" do
