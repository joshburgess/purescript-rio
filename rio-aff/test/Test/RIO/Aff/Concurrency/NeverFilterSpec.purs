module Test.RIO.Aff.Concurrency.NeverFilterSpec (spec) where
...
import RIO.Aff.Concurrency (filterPar, never, race, timeout)

spec :: Spec Unit
spec = describe "RIO.Aff.Concurrency (never / filterPar)" do
