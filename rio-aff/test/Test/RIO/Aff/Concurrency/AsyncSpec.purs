module Test.RIO.Aff.Concurrency.AsyncSpec (spec) where
...
import RIO.Aff.Concurrency (async, asyncInterrupt, fork, interrupt, race, timeout)
import RIO.Aff.Core (RIO, runRIO, runRIO')
...
spec :: Spec Unit
spec = describe "RIO.Aff.Concurrency (async / asyncInterrupt)" do
