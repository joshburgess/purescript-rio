module Test.RIO.Aff.Cause.CatchSomeSpec (spec) where
...
import RIO.Aff.Cause (Cause(..), catchSomeCause)
import RIO.Aff.Core (RIO, die, fail, runRIO, sandbox)
...
spec :: Spec Unit
spec = describe "RIO.Aff.Cause.catchSomeCause" do
