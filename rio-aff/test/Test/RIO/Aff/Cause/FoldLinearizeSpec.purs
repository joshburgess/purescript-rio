module Test.RIO.Aff.Cause.FoldLinearizeSpec (spec) where
...
import RIO.Aff.Cause (Cause(..), foldCause, linearize)
...
spec :: Spec Unit
spec = describe "RIO.Aff.Cause (foldCause / linearize)" do
