module Test.RIO.Aff.MetricsSpec (spec) where
...
import RIO.Aff.Test.Metrics (MetricKind(..), newRecordingMetrics)

spec :: Spec Unit
spec = describe "RIO.Aff.Metrics" do
