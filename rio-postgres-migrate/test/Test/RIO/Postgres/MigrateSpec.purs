-- | Integration tests for `RIO.Postgres.Migrate` against a real
-- | Postgres instance.
module Test.RIO.Postgres.MigrateSpec (spec) where
...
import RIO.Postgres.Migrate (migrate, sqlMigration)
...
spec conn = do
  describe "RIO.Postgres.Migrate (integration)" do
