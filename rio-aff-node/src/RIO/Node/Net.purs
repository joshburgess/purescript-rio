...
-- | service-shaped surface lives in the `RIO.Aff.Node.Net.Socket`,
-- | `RIO.Aff.Node.Net.Server`, `RIO.Aff.Node.Net.BlockList`, and
-- | `RIO.Aff.Node.Net.SocketAddress` submodules.
module RIO.Aff.Node.Net
  ( module Exports
  ) where
