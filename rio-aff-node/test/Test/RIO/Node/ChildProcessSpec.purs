module Test.RIO.Aff.Node.ChildProcessSpec (spec) where
...
import RIO.Aff.Node.Buffer as Buf
import RIO.Aff.Node.ChildProcess
  ( ChildProcess
  , Exit(..)
  , exitH
  ) as Exports
import RIO.Aff.Node.ChildProcess as CP
...
spec :: Spec Unit
spec = describe "RIO.Aff.Node.ChildProcess" do
