...
OpenTelemetry adapter for [`rio`](../README.md)'s `RIO.Tracer`
service.
...
- **Span events and links are not forwarded.** The `RIO.Tracer`
  record does not model them yet. Once `RIO.Tracer` grows that
